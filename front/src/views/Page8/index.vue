  ...
  <div>
    ...
    <div class="container">
      ...
      <el-table empty-text="导入数据后显示" :data="showTableData1" border class="table" ref="multipleTable" header-cell-class-name="table-header" :fit="true">
        <el-table-column v-for="(d, index) in showTableHeader1" :prop="d.code" :label="d.name"  align="center">

        </el-table-column>
      </el-table>

      <div>
        <img style="width: 100%" src="@/assets/img/page8/tips.png">
      </div>
  ...
  // 使用 data 对象可以很方便地管理组件中所需的数据，并且能够保证组件的响应性能力
    return {
      ...
      showTableHeader1: [
          ...
          { code: "date", name:"现在水平" },
          { code: "date", name: "标题" },
          { code: "date",  name: "图例名字1" },
          { code: "date", name: "图例名字2" },
      ],
      showTableData2: [],
...
.container { /*page1_bg.png图片文件放置在Vue项目的静态资源目录中，引入背景*/
  background-image: url("~@/assets/img/page8/bg.png");
