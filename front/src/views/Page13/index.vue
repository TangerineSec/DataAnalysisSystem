  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="handle-box">
        ...
        <el-button type="primary" icon="el-icon-search" @click="handlePreviewCharts" style="margin: 0px 0px 0px 10px">再查看数据</el-button>


      </div>
      导入模板说明：由于网址支持格式为xlsx的文件，不支持xls格式输入。所以如果是xls的表格数据，请复制到xlsx格式的表格中导入或下载模板文件，复制到模板文件中导入数据。
      <br>
      功能13表格模板要求在每列成绩最下方填写该列成绩自定义的最低分，范围0-100分，最高分按照100分进行自动归一化数据，具体可以下载模板数据对比查看。
      <hr>
      ...
      <div>
        <img style="width: 100%" src="https://githubwiki.oss-cn-shanghai.aliyuncs.com/img/typroa/1698245589653.png">
      </div>
...
export default {
  ...
  methods: {
    handlePreviewCharts() {
      ...
      const url = baseUrl + '/export_view13?filename1=' + this.filename1 + '&sheet1=' + this.selectedSheet1 + '&theme=' + this.selectedTheme
