<template>
  <div>
    ...
    <div class="container">
      ...
      <div>
        <img style="width: 100%" src="@/assets/img/page6/tips.png">
      </div>
...
export default {
  ...
  computed:{
    showTableheader(){
      const maxVisibleHeaders = 2; // 控制前2列
  ...
  methods: {
    ...
    handlePreviewCharts() {
      ...
      const baseUrl = process.env.VUE_APP_BASE_URL
      const url = baseUrl + '/export_pie?filename1='
...
.container { /*page1_bg.png图片文件放置在Vue项目的静态资源目录中，引入背景*/
  background-image: url("~@/assets/img/page6/bg.png");
