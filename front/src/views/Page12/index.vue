<template>
  <div>
    ...
    <div class="container">
      ...
      <br>
      功能12表格模板按照最低分60分，最高分100分进行归一化，无需自定义数据，具体可以下载模板数据对比查看。
      <hr>
...
export default {
  ...
  methods: {
    handlePreviewCharts() {
      ...
      const url = baseUrl + '/export_view12?filename1=' + this.filename1 + '&sheet1=' + this.selectedSheet1 + '&theme=' + this.selectedTheme
